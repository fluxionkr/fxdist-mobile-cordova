...
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL
import kr.co.aiblab.cordova.plugin.nfc.device.D0201.Companion.checkValidGetDataInfoPayload
import kr.co.aiblab.cordova.plugin.nfc.device.D0201.Companion.checkValidGetDataPayload
import kr.co.aiblab.cordova.plugin.nfc.device.D0201.Companion.checkValidStartConnectionPayload
import kr.co.aiblab.cordova.plugin.nfc.device.D0201.Companion.checkValidStopConnectionPayload
import kr.co.aiblab.ondago.BuildConfig
import kr.co.aiblab.ondago.utils.Event
import kr.co.aiblab.ondago.utils.showHexData
import java.util.*
