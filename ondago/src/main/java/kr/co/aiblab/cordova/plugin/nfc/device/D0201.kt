package kr.co.aiblab.cordova.plugin.nfc.device
...
import kr.co.aiblab.cordova.plugin.nfc.NFCDevice.Companion.getReqLog
import kr.co.aiblab.cordova.plugin.nfc.NFCTagException
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Companion.CNT_BLOCK_DATA
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Companion.CNT_READ_NUMBER_BLOCK
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Companion.DATA_SENSOR_TYPE_TEMPERATURE
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Companion.SIZE_DATA_SENSOR_TEMPERATURE
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Companion.formattedDateTime
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Companion.getEventCodeName
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Companion.getTemperature
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Companion.writeNdefMessage
import kr.co.aiblab.ondago.utils.convertToBytes
import kr.co.aiblab.ondago.utils.convertToInt
import kr.co.aiblab.ondago.utils.toHexString
