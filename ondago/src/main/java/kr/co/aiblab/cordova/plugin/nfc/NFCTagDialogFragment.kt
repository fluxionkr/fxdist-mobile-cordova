...
import kr.co.aiblab.cordova.plugin.nfc.NFCTagDialogFragment.TagType.Companion.READ_LOGS_DATA
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Companion.getMessage
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Status.Companion.FAILED_READ_DATA
import kr.co.aiblab.cordova.plugin.nfc.device.BoardADL.Status.Companion.NO_MORE_DATA
import kr.co.aiblab.cordova.plugin.nfc.device.D0201
import kr.co.aiblab.ondago.databinding.FragmentDialogNfcBinding
