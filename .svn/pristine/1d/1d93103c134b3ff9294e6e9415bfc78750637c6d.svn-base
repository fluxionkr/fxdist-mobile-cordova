package kr.co.kit.cordova.plugin.signpad
...
import kr.co.kit.cordova.plugin.signpad.SignPadDialogFragment.Companion.ENTRY_TAG_ERROR_CODE
import kr.co.kit.cordova.plugin.signpad.SignPadDialogFragment.Companion.ENTRY_TAG_SIGN_DATA
import kr.co.kit.kitdist.R
import kr.co.kit.kitdist.ui.MainFragmentDirections.Companion.actionSignPad
