...
import kr.co.kit.cordova.plugin.nfc.FeliCaLiteTag
import kr.co.kit.cordova.plugin.nfc.FeliCaLiteTagException
import kr.co.kit.cordova.plugin.nfc.NFCDevice
